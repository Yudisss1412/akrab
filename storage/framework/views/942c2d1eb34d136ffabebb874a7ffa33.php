...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('css/admin_penjual/style.css')); ?>">
...
<body>
  <?php echo $__env->make('components.admin_penjual.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="content-wrapper">
      ...
      <div class="page-header my-5 py-5 mb-5" style="margin-top: 2rem; margin-bottom: 3rem;">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
          <h1 class="page-title mb-0">Manajemen Promosi untuk <?php echo e(auth()->check() ? auth()->user()->name : 'Penjual'); ?></h1>
          ...
          <div class="modal-body-custom">
            <div class="promotion-types">
              <div class="promotion-type-card">
                ...
                <a class="btn btn-outline-primary" href="<?php echo e(route('penjual.promosi.diskon')); ?>">Pilih</a>
              </div>
              <div class="promotion-type-card">
                ...
                <a class="btn btn-outline-success" href="<?php echo e(route('penjual.promosi.voucher')); ?>">Pilih</a>
              </div>
            </div>
          </div>
        </div>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>Voucher</td>
                      <td>-</td>
                      <td><?php echo e(\Carbon\Carbon::parse($voucher->start_date)->format('d M Y')); ?> - <?php echo e(\Carbon\Carbon::parse($voucher->end_date)->format('d M Y')); ?></td>
                      <td>
                        <span class="status-badge 
                          <?php if($voucher->status === 'active'): ?> status-completed 
                          <?php elseif($voucher->status === 'inactive'): ?> status-upcoming 
                          <?php else: ?> status-expired <?php endif; ?>">
                      ...
                      <td>
                        <div class="action-buttons d-flex justify-content-end gap-2">
                          <a href="<?php echo e(route('penjual.promosi.edit', ['id' => $voucher->id])); ?>" class="action-btn btn-edit rounded-circle bg-light p-2 d-flex align-items-center justify-content-center" style="width: 36px; height: 36px;" title="Edit">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                              <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
                            </svg>
                          </a>
                          <button class="action-btn btn-deactivate rounded-circle bg-light p-2 d-flex align-items-center justify-content-center" style="width: 36px; height: 36px;" title="Nonaktifkan" onclick="confirmDeactivate(<?php echo e($voucher->id); ?>)">
                          ...
                          <button class="action-btn btn-delete rounded-circle bg-light p-2 d-flex align-items-center justify-content-center" style="width: 36px; height: 36px;" title="Hapus" onclick="confirmDelete(<?php echo e($voucher->id); ?>)">
                    ...
                    <?php $__currentLoopData = $productDiscounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productPromotion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td><?php echo e($productPromotion->product ? $productPromotion->product->name . ' - Diskon' : 'Produk tidak ditemukan'); ?></td>
                      <td>Diskon Produk</td>
                      <td><?php echo e($productPromotion->product ? $productPromotion->product->name : '-'); ?></td>
                      <td><?php echo e(\Carbon\Carbon::parse($productPromotion->start_date)->format('d M Y')); ?> - <?php echo e(\Carbon\Carbon::parse($productPromotion->end_date)->format('d M Y')); ?></td>
                      <td>
                        <span class="status-badge
                          <?php if($productPromotion->status === 'active'): ?> status-completed
                          <?php elseif($productPromotion->status === 'inactive'): ?> status-upcoming
                          <?php else: ?> status-expired <?php endif; ?>">
                          <?php echo e(ucfirst($productPromotion->status)); ?>

                        </span>
                      </td>
                      <td>
                        <div class="action-buttons d-flex justify-content-end gap-2">
                          <?php if($productPromotion->product): ?>
                          <a href="<?php echo e(route('penjual.promosi.edit', ['id' => $productPromotion->id])); ?>" class="action-btn btn-edit rounded-circle bg-light p-2 d-flex align-items-center justify-content-center" style="width: 36px; height: 36px;" title="Edit">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                              <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
                            </svg>
                          </a>
                          <button class="action-btn btn-deactivate rounded-circle bg-light p-2 d-flex align-items-center justify-content-center" style="width: 36px; height: 36px;" title="Nonaktifkan" onclick="confirmDeactivate(<?php echo e($productPromotion->id); ?>)">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                              <path d="M7.29314 7.99965L3.14614 3.85366C3.09966 3.80717 3.06278 3.75198 3.03762 3.69124C3.01246 3.6305 2.99951 3.5654 2.99951 3.49966C2.99951 3.43391 3.01246 3.36881 3.03762 3.30807C3.06278 3.24733 3.09966 3.19214 3.14614 3.14565C3.19263 3.09917 3.24782 3.06229 3.30856 3.03713C3.3693 3.01197 3.4344 2.99902 3.50014 2.99902C3.56589 2.99902 3.63099 3.01197 3.69173 3.03713C3.75247 3.06229 3.80766 3.09917 3.85414 3.14565L8.00014 7.29265L12.1461 3.14565C12.24 3.05177 12.3674 2.99902 12.5001 2.99902C12.6329 2.99902 12.7603 3.05177 12.8541 3.14565C12.948 3.23954 13.0008 3.36688 13.0008 3.49966C13.0008 3.63243 12.948 3.75977 12.8541 3.85366L8.70714 7.99965L12.8541 12.1457C12.948 12.2395 13.0008 12.3669 13.0008 12.4997C13.0008 12.6324 12.948 12.7598 12.8541 12.8537C12.7603 12.9475 12.6329 13.0003 12.5001 13.0003C12.3674 13.0003 12.24 12.9475 12.1461 12.8537L8.00014 8.70665L3.85414 12.8537C3.76026 12.9475 3.63292 13.0003 3.50014 13.0003C3.36737 13.0003 3.24003 12.9475 3.14614 12.8537C3.05226 12.7598 2.99951 12.6324 2.99951 12.4997C2.99951 12.3669 3.05226 12.2395 3.14614 12.1457L7.29314 7.99965Z" fill="currentColor"/>
                            </svg>
                          </button>
                          <button class="action-btn btn-delete rounded-circle bg-light p-2 d-flex align-items-center justify-content-center" style="width: 36px; height: 36px;" title="Hapus" onclick="confirmDelete(<?php echo e($productPromotion->id); ?>)">
                            <svg width="33" height="33" viewBox="0 0 33 33" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                              <path d="M5.5 9.625H27.5M13.75 15.125V23.375M19.25 15.125V23.375M6.875 9.625L8.25 26.125C8.25 26.8543 8.53973 27.5538 9.05546 28.0695C9.57118 28.5853 10.2707 28.875 11 28.875H22C22.7293 28.875 23.4288 28.5853 23.9445 28.0695C24.4603 27.5538 24.75 26.8543 24.75 26.125L26.125 9.625M12.375 9.625V5.5C12.375 5.13533 12.5199 4.78559 12.7777 4.52773C13.0356 4.26987 13.3853 4.125 13.75 4.125H19.25C19.6147 4.125 19.9644 4.26987 20.2223 4.52773C20.4801 4.78559 20.625 5.13533 20.625 5.5V9.625" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                          </button>
              ...
              <div class="table-responsive">
                <table class="table table-hover">
                  ...
                  <tbody>
                    <?php $__currentLoopData = $productDiscounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productPromotion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td><?php echo e($productPromotion->product->name); ?> - Diskon</td>
                      <td>Diskon Produk</td>
                      <td><?php echo e($productPromotion->product->name); ?></td>
                      <td><?php echo e(\Carbon\Carbon::parse($productPromotion->start_date)->format('d M Y')); ?> - <?php echo e(\Carbon\Carbon::parse($productPromotion->end_date)->format('d M Y')); ?></td>
                      <td>
                        <span class="status-badge 
                          <?php if($productPromotion->status === 'active'): ?> status-completed 
              ...
              <div class="table-responsive">
                <table class="table table-hover">
                  ...
                  <tbody>
                    <?php $__currentLoopData = $vouchers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $voucher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td><?php echo e($voucher->name); ?><br><small class="text-muted"><?php echo e($voucher->code); ?></small></td>
                      <td>
                        <?php if($voucher->type === 'free_shipping'): ?> Voucher Pengiriman
                        <?php elseif($voucher->type === 'percentage'): ?> Voucher Diskon Persen
                        <?php else: ?> Voucher Diskon Tetap
                        <?php endif; ?>
                      </td>
                      <td>Rp <?php echo e(number_format($voucher->min_order_amount, 0, ',', '.')); ?></td>
                      <td><?php echo e($voucher->used_count); ?>/<?php echo e($voucher->usage_limit ?: '∞'); ?></td>
                      <td><?php echo e(\Carbon\Carbon::parse($voucher->start_date)->format('d M Y')); ?> - <?php echo e(\Carbon\Carbon::parse($voucher->end_date)->format('d M Y')); ?></td>
                      <td>
                        <span class="status-badge 
                          <?php if($voucher->status === 'active'): ?> status-completed 
  ...
  <?php echo $__env->make('components.admin_penjual.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php /**PATH C:\xampp\htdocs\ecommerce-akrab\resources\views/penjual/manajemen_promosi.blade.php ENDPATH**/ ?>