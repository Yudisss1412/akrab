      ...
      <main class="admin-page-content main-content">
        ...
        <div class="detail-container">
          ...
          <div class="detail-content">
            ...
            <div class="row mt-3">
              <div class="col-12">
                <a href="{{ route('sellers.index') }}" class="btn btn-secondary">Kembali ke Daftar</a>
                <a href="{{ route('sellers.edit', $seller) }}" class="btn btn-primary">Edit</a>
                ...
                @if($seller->status !== 'ditangguhkan')
                  <form action="{{ route('sellers.suspend', $seller) }}" method="POST" class="d-inline">
                    @csrf
                    <button type="submit" class="btn btn-warning" onclick="return confirm('Apakah Anda yakin ingin menangguhkan penjual ini?')">Tangguhkan</button>
                  </form>
                @else
                  <form action="{{ route('sellers.activate', $seller) }}" method="POST" class="d-inline">
                    @csrf
                    <button type="submit" class="btn btn-success" onclick="return confirm('Apakah Anda yakin ingin mengaktifkan kembali penjual ini?')">Aktifkan</button>
                  </form>
                @endif
              </div>
            </div>
