            ...
            if (productsContainer) {
              ...
              if (data.products && data.products.length > 0) {
                ...
                data.products.forEach(product => {
                  ...
                  // Get product image - use formatted_images array or main_image
                  let imageUrl = 'src/placeholder_produk.png';
                  if (product.formatted_images && product.formatted_images.length > 0) {
                    imageUrl = product.formatted_images[0];
                  ...
                  img.onerror = function() {
                    ...
                    this.src = 'src/placeholder_produk.png'; // Fallback to default placeholder
                  };
                  ...
                  // Format price to IDR
                  const formattedPrice = 'Rp ' + parseInt(product.harga || product.price || 0).toLocaleString('id-ID');
