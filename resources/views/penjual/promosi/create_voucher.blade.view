      ...
      <form id="createVoucherForm">
        ...
        <div class="form-card">
          ...
          <div class="form-group">
            ...
            <input type="text" id="voucherName" class="form-control" placeholder="Contoh: Voucher Hemat Akhir Tahun">
          </div>
          
          <div class="form-group">
            <label for="voucherCode" class="form-label">Kode Voucher</label>
            <div class="input-group">
              <input type="text" id="voucherCode" class="form-control" placeholder="Contoh: HEMAT2024">
        ...
        <div class="form-card">
          ...
          <div class="form-group">
            ...
            <div class="radio-group">
              <div class="radio-option">
                <input type="radio" id="typePercentage" name="discountType" value="percentage" checked>
                <label for="typePercentage">Persentase (%)</label>
              </div>
              <div class="radio-option">
                <input type="radio" id="typeFixed" name="discountType" value="fixed">
          ...
          <div class="form-group">
            ...
            <input type="number" id="discountValue" class="form-control" placeholder="Masukkan besar diskon">
          </div>
          ...
          <div class="form-group max-discount-group" id="maxDiscountGroup">
            ...
            <input type="number" id="maxDiscount" class="form-control" placeholder="Masukkan maksimum potongan">
          </div>
        </div>
        ...
        <div class="form-card">
          ...
          <div class="form-group">
            ...
            <input type="number" id="minPurchase" class="form-control" placeholder="Rp 0">
          </div>
          
          <div class="form-group">
            <label for="quota" class="form-label">Kuota Penggunaan</label>
            <input type="number" id="quota" class="form-control" placeholder="Jumlah total voucher yang tersedia">
          </div>
        </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      form.addEventListener('submit', function(e) {
        ...
        // Di sini Anda akan menambahkan logika untuk menyimpan voucher
