...
@section('content')
      ...
      <div class="content-wrapper">
        ...
        <ul class="nav nav-tabs" id="userTabs" role="tablist">
          <li class="nav-item" role="presentation">
            <button class="nav-link active" id="sellers-tab" data-bs-toggle="tab" data-bs-target="#sellers-tab-pane" type="button" role="tab">Penjual</button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="buyers-tab" data-bs-toggle="tab" data-bs-target="#buyers-tab-pane" type="button" role="tab">Pembeli</button>
          </li>
        </ul>
        ...
        <div class="tab-content" id="userTabsContent">
          <!-- Sellers Tab -->
          <div class="tab-pane fade show active" id="sellers-tab-pane" role="tabpanel">
            <div class="mt-3">
              ...
              <div class="filter-panel">
                ...
                <div class="filter-content">
                  <form id="filterForm" method="GET" action="{{ route('sellers.index') }}">
                    <div class="row g-2">
                      <div class="col-md-5 mb-2">
                        <label for="search" class="form-label">Cari Penjual</label>
                        <input type="text" class="form-control" id="search" name="search" value="{{ request('search') }}" placeholder="Nama Toko, Nama Pemilik, atau Email" onchange="submitForm()">
                      </div>
                      ...
                      <div class="col-md-2 mb-2">
                        ...
                        <input type="date" class="form-control" id="join_date_from" name="join_date_from" value="{{ request('join_date_from') }}" onchange="submitForm()">
                      </div>
                      <div class="col-md-2 mb-2">
                        <label for="join_date_to" class="form-label">Bergabung Sampai</label>
                        <input type="date" class="form-control" id="join_date_to" name="join_date_to" value="{{ request('join_date_to') }}" onchange="submitForm()">
                      </div>
                ...
                <div class="table-content">
                  ...
                  <table class="table table-striped table-hover">
                    ...
                    <tbody>
                      ...
                      @empty
                      <tr>
                        <td colspan="5" class="text-center py-4">Tidak ada data penjual ditemukan.</td>
                      </tr>
                      @endforelse
                    </tbody>
                  </table>
                ...
                <div class="mt-3 d-flex justify-content-between align-items-center">
                  ...
                  <nav aria-label="Halaman penjual">
                    <ul class="pagination mb-0">
                      ...
                      @else
                        <li class="page-item">
                          <a class="page-link" href="{{ $sellers->previousPageUrl() }}" aria-label="Previous">
                      ...
                      @for ($i = max(1, $sellers->currentPage() - 2); $i <= min($sellers->lastPage(), $sellers->currentPage() + 2); $i++)
                        ...
                        @else
                          <li class="page-item"><a class="page-link" href="{{ $sellers->url($i) }}">{{ $i }}</a></li>
                        @endif
                      @endfor

                      @if ($sellers->hasMorePages())
                        <li class="page-item">
                          <a class="page-link" href="{{ $sellers->nextPageUrl() }}" aria-label="Next">
        ...
        <div class="tab-pane fade" id="buyers-tab-pane" role="tabpanel">
          <div class="mt-3">
            ...
            <div class="filter-panel">
              ...
              <div class="filter-content">
                <form id="filterFormBuyers" method="GET" action="{{ url()->current() }}?tab=buyers">
                  <div class="row g-2">
                    <div class="col-md-5 mb-2">
                      <label for="buyer_search" class="form-label">Cari Pembeli</label>
                      <input type="text" class="form-control" id="buyer_search" name="search" placeholder="Nama Pembeli, Email" onchange="submitBuyerForm()">
                    </div>
                    <div class="col-md-2 mb-2">
                      <label for="buyer_status" class="form-label">Status</label>
                      <select class="form-select" id="buyer_status" name="status" onchange="submitBuyerForm()">
                        <option value="">Semua</option>
                    ...
                    <div class="col-md-2 mb-2">
                      ...
                      <input type="date" class="form-control" id="join_date_from_buyer" name="join_date_from" onchange="submitBuyerForm()">
                    </div>
                    <div class="col-md-2 mb-2">
                      <label for="join_date_to_buyer" class="form-label">Bergabung Sampai</label>
                      <input type="date" class="form-control" id="join_date_to_buyer" name="join_date_to" onchange="submitBuyerForm()">
                    </div>
                    <div class="col-md-1 mb-2 d-flex align-items-end">
                      <button type="button" class="btn btn-secondary w-100" onclick="clearBuyerFilters()">
                        <i class="fas fa-times"></i>
                      </button>
                    </div>
                  </div>
            ...
            <div class="table-container mt-2">
              ...
              <div class="table-content">
                ...
                <table class="table table-striped table-hover">
                  ...
                  <tbody>
                    <!-- Example buyer rows - would be populated by real data -->
                    <tr>
                      <td>
                        <div><strong>Ronald Richards</strong></div>
                        <small class="text-muted">ronald.richards@example.com</small><br>
                        <small class="text-muted">Bergabung: 15 Agu 2024</small>
                      </td>
                      <td>
                        <div>Transaksi: <strong>12</strong></div>
                        <div>Spending: <strong>Rp 3.450.000</strong></div>
                      </td>
                      <td>
                        <span class="badge rounded-pill bg-success d-block">Aktif</span>
                      </td>
                      <td>
                        <div class="btn-group d-block" role="group">
                          <a href="javascript:void(0)" class="btn btn-info d-block text-center square-btn" title="Lihat Riwayat Transaksi">
                            <i class="fas fa-history"></i>
                          </a>
                          <a href="javascript:void(0)" class="btn btn-primary d-block text-center square-btn" title="Edit Profil">
                            <i class="fas fa-edit"></i>
                          </a>
                    ...
                    <tr>
                      <td>
                        <div><strong>Jenny Wilson</strong></div>
                        <small class="text-muted">jenny.wilson@example.com</small><br>
                        <small class="text-muted">Bergabung: 22 Agu 2024</small>
                      </td>
                      <td>
                        <div>Transaksi: <strong>8</strong></div>
                        <div>Spending: <strong>Rp 1.200.000</strong></div>
                      </td>
                      <td>
                        <span class="badge rounded-pill bg-success d-block">Aktif</span>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div><strong>Jerome Bell</strong></div>
                        <small class="text-muted">jerome.bell@example.com</small><br>
                        <small class="text-muted">Bergabung: 05 Sep 2024</small>
                      </td>
                      <td>
                        <div>Transaksi: <strong>3</strong></div>
                        <div>Spending: <strong>Rp 450.000</strong></div>
                      </td>
                      <td>
                        <span class="badge rounded-pill bg-danger d-block">Ditangguhkan</span>
                      </td>
                      <td>
                        <div class="btn-group d-block" role="group">
                          <a href="javascript:void(0)" class="btn btn-info d-block text-center square-btn" title="Lihat Riwayat Transaksi">
                    ...
                    <tr>
                      <td colspan="4" class="text-center py-4">Tidak ada data pembeli ditemukan.</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div class="mt-3 d-flex justify-content-between align-items-center">
                <div>
                  Menampilkan 1 sampai 10 dari 25 pembeli
                </div>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    // No bulk actions functionality since it has been removed
  });
  </script>
