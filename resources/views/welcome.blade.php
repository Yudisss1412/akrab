            ...
            <div class="intro-container">
                <div class="intro-text animate-on-scroll">
                    ...
                    <h1 class="main-headline">
                        <span class="line-umkm">UMKM</span>
                ...
                <div class="intro-visual animate-on-scroll delay-1">
                    ...
                    <div class="intro-desc">
                        Temukan keistimewaan di setiap detail — produk UMKM terbaik Banyuwangi, dibuat penuh dedikasi dan cita rasa khas nusantara, hanya untuk Anda.
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="populer" class="main-section">
            <div class="product-grid">
                <article class="product-card animate-on-scroll" 
                        ...
                        data-img-src="src/product_1.png"
                        data-desc="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.">
    ...
    <footer class="footer">
        ...
        <div class="social-icons-container">
            <div class="social-icons-background">
                <a href="https://www.instagram.com/akrab_banyuwangi" target="_blank" class="social-icon" aria-label="Instagram">
                ...
                <a href="https://web.facebook.com/akrabbanyuwangi" target="_blank" class="social-icon" aria-label="Facebook">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-details">
                ...
                <div class="modal-rating">
                    ...
                    <svg viewBox="0 0 24 24"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"></path></svg>
                    <svg viewBox="0 0 24 24"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"></path></svg>
                    <svg viewBox="0 0 24 24" class="star-empty"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"></path></svg>
                </div>
