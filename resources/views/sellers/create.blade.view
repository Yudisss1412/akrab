...
<head>
  <meta charset="utf-8">
  <title>Tambah Penjual Baru — AKRAB</title>
    ...
    <div class="content-wrapper">
      <main class="admin-page-content main-content">
        <div class="page-header">
          <h2 class="page-title">Tambah Penjual Baru</h2>
        ...
        <div class="form-container">
          <div class="form-header">
            <h3 class="form-title">Form Tambah Penjual</h3>
          </div>
          <div class="form-content">
            <form action="{{ route('sellers.store') }}" method="POST">
              ...
              <div class="mb-3">
                <button type="submit" class="btn btn-primary">Simpan Penjual</button>
