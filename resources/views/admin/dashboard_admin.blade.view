...
@section('content')
          ...
          <div class="widget">
            ...
            <div class="widget-content expanded">
              <div class="shortcut-grid">
                ...
                <a href="{{ route('produk.index') }}" class="shortcut-btn">
                  <div class="shortcut-icon">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <script>
    ...
    function updateMetrics(range) {
      ...
      document.querySelectorAll('.stat-card .stat-value')[0].textContent = data.activeSellers;
      document.querySelectorAll('.stat-card .stat-value')[1].textContent = data.newSellers;
      document.querySelectorAll('.stat-card .stat-value')[2].textContent = data.suspendedSellers;
      document.querySelectorAll('.stat-card .stat-value')[3].textContent = data.pendingVerification;
      document.querySelectorAll('.stat-card .stat-value')[4].textContent = data.activeBuyers;
      document.querySelectorAll('.stat-card .stat-value')[5].textContent = data.totalTransactions;
    }
    ...
    function updateCharts(range) {
      ...
      document.querySelectorAll('svg')[0].querySelectorAll('polyline')[1].setAttribute('points', gmvPoints);
      document.querySelectorAll('svg')[1].querySelectorAll('polyline')[1].setAttribute('points', revenuePoints);
    }
