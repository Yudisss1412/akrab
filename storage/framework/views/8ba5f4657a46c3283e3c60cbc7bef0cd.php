<style>
  .header .profile-ico, .header .cart-ico, .header .ticket-ico {
...
<header class="header">
  <div class="header-left">
    <a href="<?php echo e(route('cust.welcome')); ?>">
      <img class="logo" src="<?php echo e(asset('src/Logo_UMKM.png')); ?>" alt="AKRAB Logo" />
    </a>
  </div>
  ...
  <button class="hamburger-menu" id="hamburger-btn" aria-label="Buka menu">
    ...
    <?php if($totalNotifications > 0): ?>
      <span class="hamburger-badge"><?php echo e($totalNotifications); ?></span>
    <?php endif; ?>
  </button>

  <div class="header-right">
    <!-- Cart with Count Badge -->
    <a href="<?php echo e(route('keranjang')); ?>" class="cart-badge" aria-label="Keranjang Belanja">
      <div class="cart-ico">
    ...
    <!-- Ticket Notification -->
    <a href="<?php echo e(route('customer.tickets')); ?>" class="ticket-badge" aria-label="Tiket Bantuan">
      ...
      <?php if($openTicketCount > 0): ?>
        <span class="ticket-count"><?php echo e($openTicketCount); ?></span>
      <?php endif; ?>
    </a>

    <a href="<?php echo e(route('profil.pembeli')); ?>" class="profile-ico" aria-label="Profil Pembeli">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="sidebar" id="sidebar">
  ...
  <div class="sidebar-content">
    <!-- Cart with Count Badge -->
    <a href="<?php echo e(route('keranjang')); ?>" class="sidebar-link">
      ...
      ?>
      <?php if($cartCount > 0): ?>
        <span class="cart-count" style="margin-left: auto;"><?php echo e($cartCount); ?></span>
      <?php endif; ?>
    </a>

    <!-- Ticket Notification -->
    <a href="<?php echo e(route('customer.tickets')); ?>" class="sidebar-link">
      <div class="sidebar-icon">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M14 2H6C5.46957 2 4.96086 2.21071 4.58579 2.58579C4.21071 2.96086 4 3.46957 4 4V20C4 20.5304 4.21071 21.0391 4.58579 21.4142C4.96086 21.7893 5.46957 22 6 22H18C18.5304 22 19.0391 21.7893 19.4142 21.4142C19.7893 21.0391 20 20.5304 20 20V8L14 2Z" stroke="#006E5C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M14 2V8H20" stroke="#006E5C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      ?>
      <?php if($openTicketCount > 0): ?>
        <span class="ticket-count" style="margin-left: auto;"><?php echo e($openTicketCount); ?></span>
      <?php endif; ?>
    </a>

    <!-- Profile Link -->
    <a href="<?php echo e(route('profil.pembeli')); ?>" class="sidebar-link">
      <div class="sidebar-icon">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M12 10C14.2091 10 16 8.20914 16 6C16 3.79086 14.2091 2 12 2C9.79086 2 8 3.79086 8 6C8 8.20914 9.79086 10 12 10Z" stroke="#006E5C" stroke-width="1.5"/>
        <path d="M20 17.5C20 19.985 20 22 12 22C4 22 4 19.985 4 17.5C4 15.015 7.582 13 12 13C16.418 13 20 15.015 20 17.5Z" stroke="#006E5C" stroke-width="1.5"/>
...
</script><?php /**PATH C:\xampp\htdocs\ecommerce-akrab\resources\views/components/customer/header/header.blade.php ENDPATH**/ ?>