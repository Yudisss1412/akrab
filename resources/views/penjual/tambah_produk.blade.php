...
@section('title', 'Tambah Produk - UMKM AKRAB')
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h1 class="h3 mb-4">Tambah Produk Baru</h1>
            
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('penjual.produk.store') }}" method="POST" enctype="multipart/form-data" id="productForm">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <!-- Spesifikasi & Fitur -->
                                <div class="mb-4">
                                    <h5>Spesifikasi & Fitur Produk</h5>
                                    <hr>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('specifications') is-invalid @enderror"
                                                  ...
                                                  placeholder="Contoh: Daya tahan baterai 12 jam, Tekanan maksimal 2 bar, dll">{{ old('specifications') }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('features') is-invalid @enderror"
                                                  ...
                                                  placeholder="Contoh: Tahan air, Mudah dibersihkan, Dilengkapi remote, dll">{{ old('features') }}</textarea>
                                        @error('features')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('weight') is-invalid @enderror"
                                               id="weight" name="weight" value="{{ old('weight', 0) }}" min="0" step="1" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-4">
                                    <h5>Kategori & Informasi Tambahan</h5>
                                    <hr>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('origin') is-invalid @enderror"
                                                    ...
                                                    <option value="Banyuwangi" {{ old('origin') == 'Banyuwangi' ? 'selected' : '' }}>Banyuwangi</option>
                                                    <option value="Giri" {{ old('origin') == 'Giri' ? 'selected' : '' }}>Giri</option>
                                                    <option value="Wongsorejo" {{ old('origin') == 'Wongsorejo' ? 'selected' : '' }}>Wongsorejo</option>
                                                    <option value="Songgon" {{ old('origin') == 'Songgon' ? 'selected' : '' }}>Songgon</option>
                                                    <option value="Sempu" {{ old('origin') == 'Sempu' ? 'selected' : '' }}>Sempu</option>
                                                    <option value="Kalipuro" {{ old('origin') == 'Kalipuro' ? 'selected' : '' }}>Kalipuro</option>
                                                    <option value="Siliragung" {{ old('origin') == 'Siliragung' ? 'selected' : '' }}>Siliragung</option>
                                                    <option value="Srono" {{ old('origin') == 'Srono' ? 'selected' : '' }}>Srono</option>
                                                    <option value="Glenmore" {{ old('origin') == 'Glenmore' ? 'selected' : '' }}>Glenmore</option>
                                                    <option value="Singojuruh" {{ old('origin') == 'Singojuruh' ? 'selected' : '' }}>Singojuruh</option>
                                                    <option value="Rogojampi" {{ old('origin') == 'Rogojampi' ? 'selected' : '' }}>Rogojampi</option>
                                                    <option value="Kabat" {{ old('origin') == 'Kabat' ? 'selected' : '' }}>Kabat</option>
                                                    <option value="Genteng" {{ old('origin') == 'Genteng' ? 'selected' : '' }}>Genteng</option>
                                                    <option value="Sukojati" {{ old('origin') == 'Sukojati' ? 'selected' : '' }}>Sukojati</option>
                                                    <option value="Glagah" {{ old('origin') == 'Glagah' ? 'selected' : '' }}>Glagah</option>
                                                    <option value="Licin" {{ old('origin') == 'Licin' ? 'selected' : '' }}>Licin</option>
                                                    <option value="Tegaldlimo" {{ old('origin') == 'Tegaldlimo' ? 'selected' : '' }}>Tegaldlimo</option>
                                                    <option value="Blimbing" {{ old('origin') == 'Blimbing' ? 'selected' : '' }}>Blimbing</option>
                                                    <option value="Muncar" {{ old('origin') == 'Muncar' ? 'selected' : '' }}>Muncar</option>
                                                    <option value="Kalibaru" {{ old('origin') == 'Kalibaru' ? 'selected' : '' }}>Kalibaru</option>
                                                    <option value="Gambiran" {{ old('origin') == 'Gambiran' ? 'selected' : '' }}>Gambiran</option>
                                                    <option value="Sempol" {{ old('origin') == 'Sempol' ? 'selected' : '' }}>Sempol</option>
                                                    <option value="Tegalsari" {{ old('origin') == 'Tegalsari' ? 'selected' : '' }}>Tegalsari</option>
                                                </select>
                                                @error('origin')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <button type="submit" class="btn btn-primary" id="saveProductBtn">
                                    <span id="buttonText">Simpan Produk</span>
