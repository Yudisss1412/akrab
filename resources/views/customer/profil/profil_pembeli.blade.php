  ...
  <script>
    ...
    async function fetchWishlist() {
      try {
        ...
        // Dalam pengembangan ini, kita gunakan data dummy sebagai contoh
    ...
    document.addEventListener('click', (e)=>{
      ...
      const idx = WISHLIST.findIndex(it => it.id === id);
      if (idx !== -1) {
        // Dalam pengembangan real, ini akan memanggil API untuk menghapus dari wishlist
        WISHLIST.splice(idx, 1); // remove dari wishlist
        renderWishlist();
      }
    });
