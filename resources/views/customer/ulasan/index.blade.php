        ...
        @foreach($reviews as $review)
          <div class="review-item">
            <div class="product-info">
              <img src="{{ $review->product->main_image ? asset('storage/' . $review->product->main_image) : asset('src/placeholder_produk.png') }}" alt="{{ $review->product->name }}">
            ...
            <div class="review-content">
              ...
              @if($review->media)
                <div class="review-media">
                  @foreach(json_decode($review->media) as $mediaPath)
                    <img src="{{ asset('storage/' . $mediaPath) }}" alt="Foto ulasan" class="review-media-item">
                  @endforeach
                </div>
              @endif
            </div>
