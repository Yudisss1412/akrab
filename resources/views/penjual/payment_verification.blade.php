...
@section('title', 'Verifikasi Pembayaran - Penjual')

@section('header')
  @include('components.penjual.header.header')
@endsection

@section('content')
  <div class="container-fluid">
    <div class="row">
      <!-- Sidebar untuk navigasi seller -->
      @include('components.penjual.sidebar.sidebar')
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <tbody id="pendingPaymentsTable">
              ...
              @empty
                <tr>
                  <td colspan="7" class="text-center">Tidak ada pembayaran yang menunggu verifikasi</td>
                </tr>
              @endforelse
            </tbody>
          </table>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <img id="proofImageForVerification" src="" alt="Bukti Pembayaran" class="img-fluid mb-2">
        </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <img id="proofImageForRejection" src="" alt="Bukti Pembayaran" class="img-fluid mb-2">
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
...
@push('scripts')
  <script>
    ...
    function performSearch() {
      ...
      let url = '{{ route("penjual.pembayaran.verifikasi") }}';
