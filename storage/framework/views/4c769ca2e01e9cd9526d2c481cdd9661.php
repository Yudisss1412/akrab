...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('css/penjual/dashboard_penjual.css')); ?>">
</head>
<body>
      ...
      <main class="content admin-page-content" role="main">
        ...
        <section class="stats-grid">
          <div class="stat-card">
            ...
            <p class="stat-value">Rp <?php echo e(number_format($stats['this_month_revenue'], 0, ',', '.')); ?></p>
          </div>
          ...
          <div class="stat-card">
            ...
            <p class="stat-value"><?php echo e($stats['new_orders']); ?></p>
          </div>
          ...
          <div class="stat-card">
            ...
            <p class="stat-value"><?php echo e(number_format($stats['viewed_products'])); ?></p>
          </div>
          ...
          <div class="stat-card">
            ...
            <p class="stat-value"><?php echo e($stats['store_rating']); ?> ⭐</p>
          </div>
        </section>
            ...
            <section class="card card-urgent-tasks">
              ...
              <ul class="action-list">
                <li class="action-item">
                  <a href="<?php echo e(route('penjual.pesanan')); ?>" class="action-link">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span class="action-count" id="pending-orders-count"><?php echo e($stats['pending_orders']); ?></span>
                </li>
                <li class="action-item">
                ...
                <li class="action-item">
                  <a href="<?php echo e(route('penjual.komplain.retur')); ?>" class="action-link">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span class="action-count" id="total-urgent-count"><?php echo e($stats['urgent_complaints']); ?></span>
                </li>
              </ul>
            </section>
          ...
          <div class="right-column">
            ...
            <section class="card card-quick-links">
              ...
              <ul class="quick-links">
                <li>
                  <a href="<?php echo e(route('penjual.produk')); ?>" class="quick-link">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                  <a href="<?php echo e(route('penjual.pesanan')); ?>" class="quick-link">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                  <a href="<?php echo e(route('penjual.saldo')); ?>" class="quick-link">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                  <a href="<?php echo e(route('seller.reviews.index')); ?>" class="quick-link">
                    <svg width="24" height="24" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <script>
    ...
    function fetchUrgentTasks() {
      ...
      fetch('<?php echo e(route('penjual.urgent.tasks')); ?>', {
        method: 'GET',
        headers: {
...
<?php /**PATH C:\xampp\htdocs\ecommerce-akrab\resources\views/penjual/dashboard_penjual.blade.php ENDPATH**/ ?>