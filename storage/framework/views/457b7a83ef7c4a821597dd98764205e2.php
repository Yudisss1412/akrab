...
<?php $__env->startSection('title', 'Admin Dashboard - AKRAB'); ?>

<?php $__env->startPush('styles'); ?>
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="<?php echo e(asset('css/admin/dashboard_admin.css')); ?>">
          ...
          <div class="widget">
            ...
            <div class="widget-content expanded">
              <div class="shortcut-grid">
                <a href="<?php echo e(route('sellers.index')); ?>" class="shortcut-btn">
                ...
                <a href="<?php echo e(route('admin.produk.index')); ?>" class="shortcut-btn">
                  <div class="shortcut-icon">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="widget">
            ...
            <div class="widget-content expanded">
              <div class="metric-card-container">
                <a href="<?php echo e(route('reports.violations')); ?>" class="metric-link">
                  <div class="metric-card">
              ...
              <div class="metric-card-container">
                <a href="<?php echo e(route('support.tickets')); ?>" class="metric-link">
                  <div class="metric-card">
              ...
              <div class="metric-card-container">
                <a href="<?php echo e(route('withdrawal.requests')); ?>" class="metric-link">
                  <div class="metric-card">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce-akrab\resources\views/admin/dashboard_admin.blade.php ENDPATH**/ ?>