...
@section('title', 'Edit Voucher Toko - ' . $promotion['name'])
    ...
    <div class="container-fluid">
      ...
      <div class="page-header">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
          ...
          <h1 class="page-title mb-0">Edit Voucher Toko: {{ $promotion['name'] }}</h1>
        </div>
      </div>
      ...
      <form id="editVoucherForm">
        ...
        <div class="form-card">
          ...
          <div class="form-group">
            ...
            <input type="text" id="voucherName" class="form-control" value="{{ $promotion['name'] }}" placeholder="Contoh: Voucher Hemat Akhir Tahun">
          </div>
          
          <div class="form-group">
            <label for="voucherCode" class="form-label">Kode Voucher</label>
            <div class="input-group">
              <input type="text" id="voucherCode" class="form-control" value="VOUCHER2024" placeholder="Contoh: HEMAT2024">
        ...
        <div class="form-card">
          ...
          <div class="form-group max-discount-group" id="maxDiscountGroup">
            ...
            <input type="number" id="maxDiscount" class="form-control" value="50000" placeholder="Masukkan maksimum potongan">
          </div>
        </div>
        ...
        <div class="form-card">
          ...
          <div class="form-group">
            ...
            <input type="number" id="minPurchase" class="form-control" value="{{ $promotion['min_purchase'] }}" placeholder="Rp 0">
          </div>
          
          <div class="form-group">
            <label for="quota" class="form-label">Kuota Penggunaan</label>
            <input type="number" id="quota" class="form-control" value="{{ $promotion['quota'] }}" placeholder="Jumlah total voucher yang tersedia">
          </div>
        </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      form.addEventListener('submit', function(e) {
        ...
        // Di sini Anda akan menambahkan logika untuk menyimpan perubahan voucher
        alert('Perubahan voucher berhasil disimpan!');
