            ...
            <div class="carousel-container">
                <div class="carousel-track" id="carousel-track">
                    ...
                    <article class="product-card carousel-item"
                            ...
                            data-desc="<?php echo e(Str::limit($product->description, 100)); ?>"
                            data-images="<?php echo e($product->main_image ? asset('storage/' . $product->main_image) : 'https://placehold.co/600x800/eee/333?text=No+Image'); ?>"
                            data-specs="<?php echo e($product->specifications ? collect($product->specifications)->map(fn($v, $k) => "$k:$v")->join('|') : ''); ?>"
                            data-product-slug="<?php echo e(Str::slug($product->name)); ?>">
                        <img src="<?php echo e($product->main_image ? asset('storage/' . $product->main_image) : 'https://placehold.co/400x400/333/fff?text=' . urlencode($product->name)); ?>"
                             alt="<?php echo e($product->name); ?>"
                             onerror="this.onerror=null;this.src='https://placehold.co/400x400/333/fff?text=<?php echo e(urlencode($product->name)); ?>'">
...
<?php /**PATH C:\xampp\htdocs\ecommerce-akrab\resources\views/welcome.blade.php ENDPATH**/ ?>